...
class CottonForecastModel:
    def __init__(self, changepoint_prior_scale=0.05, seasonality_prior_scale=10.0):
        """
        Initializes the Prophet model for Cotton price forecasting.
        """
        self.model = Prophet(
            daily_seasonality=False,   # Cotton markets are closed on weekends, daily seasonality might be noisy
